...
class HomePassengerPanel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        height20,
        (viewModel.getModel?.driverIdx == 0
                ? "현재 매칭된 기사가 없습니다."
                : "현재 탑승 인원 : ${viewModel.getModel?.numberOfPeopleOnBard ?? 0}")
            .text
            .make(),
        height20,
        HomeLocationPanel(
          ...
          color: Colors.red,
          iconText: "출발",
          address: viewModel.getModel?.startAddress,
        ...
        HomeLocationPanel(
          ...
          iconText: "도착",
          address: viewModel.getModel?.endAddress,
