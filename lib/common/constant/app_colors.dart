...
class AppColors {
  static const Color mainGreenColor = Color.fromARGB(255, 82, 166, 114);
  static const Color deepGreyColor = Color.fromARGB(255, 119, 119, 119);
  ...
  static const Color defaultBackgroundGreyColor = Color.fromARGB(255, 245, 245, 245);
  static const Color brightGrey = Color.fromARGB(255, 228, 228, 228);
  static const Color lightGrey = Color.fromARGB(255, 225, 225, 225);
  static const Color borderGrey = Color.fromARGB(255, 221, 221, 221);
